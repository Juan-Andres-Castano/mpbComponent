...
STATUS_T mpbCommandHandlerSetup(MESSAGE_T* Msg)
{
...
STATUS_T mpbCommandHandlerStandby(MESSAGE_T* Msg)
{

}
//STATUS_T mpbCommandHandlerSetup(MESSAGE_T* Msg);
STATUS_T mpbCommandHandlerUpdate(MESSAGE_T* Msg)
{

}
STATUS_T mpbCommandHandlerBeaconOff(MESSAGE_T* Msg)
{

}
STATUS_T mpbCommandHandlerGetLedEnable(MESSAGE_T* Msg)
{

}
STATUS_T mpbCommandHandlerSetLedEnable(MESSAGE_T* Msg)
{
